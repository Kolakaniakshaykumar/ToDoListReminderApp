...
class UpdateTaskActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            UpdateTaskListScreen(taskViewModel = TaskViewModel(application))
        }
    }
}
...
@Composable
fun UpdateTaskListScreen(taskViewModel: TaskViewModel) {
                        ...
                        Card(
                            ...
                            Column(modifier = Modifier.padding(12.dp)) {
                                ...
                                Row(modifier = Modifier.fillMaxWidth()) {
                                    ...
                                    Text("Task Date adn Time", modifier = Modifier.weight(1f))
                                    Text(": ")
                                    Text(
                                        "${task.date} ${task.time}",
                                        modifier = Modifier.weight(1f),
